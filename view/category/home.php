...
//getting all home articles
$query_string = "SELECT * FROM article WHERE category='Haushalt' ORDER BY $sort $order";
$article_data = get_article_data_by_sqlquery($query_string);

$data = array_merge($user_data, $article_data);
$data['page_title']="Haushalt";
$data['link_to_sort']="../category/home.php?";
